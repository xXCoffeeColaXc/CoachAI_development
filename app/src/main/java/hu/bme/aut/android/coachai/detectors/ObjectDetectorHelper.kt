...
class ObjectDetectorHelper(
    ...
    fun setupObjectDetector() {
        ...
        val modelName = "mp_mobnet_100ep_001lr_nocos.tflite"
        ...
        try {
            ...
            objectDetectorListener?.onErrorDet(
    ...
    private fun returnLivestreamResult(
        ...
        //Log.d("DETECTOR", "size: ${result.detections().size}")

        objectDetectorListener?.onResultsDet(
            ResultBundle(
                listOf(result),
                inferenceTime,
                input.height,
    ...
    interface DetectorListener {
        fun onResultsDet(resultBundle: ResultBundle)
        fun onErrorDet(error: String, errorCode: Int = OTHER_ERROR)
    }
}